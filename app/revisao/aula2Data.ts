...
export const AULA2_KEY_PHRASES: LessonPhrase[] = [
  { id: 'a2-son-check', hanzi: '这是您儿子吗？', spokenPinyin: 'zhè shì | nín érzi ma?', translation: 'Este é o seu filho?', note: '您 é a forma respeitosa de 你.' },
  { id: 'a2-yes', hanzi: '是的。', spokenPinyin: 'shì de.', translation: 'Sim.' },
  { id: 'a2-not-son', hanzi: '不是，他不是我儿子。', spokenPinyin: 'bú shì, | tā bú shì | wǒ érzi.', translation: 'Não, ele não é meu filho.' },
  { id: 'a2-student-check', hanzi: '他是你的学生吗？', spokenPinyin: 'tā shì | nǐ de xuésheng ma?', translation: 'Ele é seu aluno?' },
  { id: 'a2-two-children', hanzi: '我有两个孩子，一个儿子，一个女儿。', spokenPinyin: 'wó yǒu | liǎng ge | háizi, | yí ge | érzi, | yí ge | nǚ’ér.', translation: 'Tenho dois filhos: um filho e uma filha.', note: 'Blocos de fala: 我有 | 两个 | 孩子；一个 | 儿子；一个 | 女儿.' },
  { id: 'a2-how-many-children', hanzi: '您有几个孩子？', spokenPinyin: 'nín yǒu | jǐ ge | háizi?', translation: 'Quantos filhos o senhor ou a senhora tem?' },
  { id: 'a2-how-many-children-duoshao', hanzi: '您有多少个孩子？', spokenPinyin: 'nín yǒu | duōshao ge | háizi?', translation: 'Quantos filhos o senhor ou a senhora tem?' },
  { id: 'a2-son-age', hanzi: '您儿子几岁？', spokenPinyin: 'nín érzi | jǐ suì?', translation: 'Quantos anos tem o seu filho?' },
  { id: 'a2-son-five', hanzi: '他今年五岁。', spokenPinyin: 'tā jīnnián | wǔ suì.', translation: 'Ele tem cinco anos.' },
  { id: 'a2-daughter-age', hanzi: '您女儿多大？', spokenPinyin: 'nín nǚ’ér | duō dà?', translation: 'Quantos anos tem a sua filha?' },
  { id: 'a2-daughter-twelve', hanzi: '她今年十二岁。', spokenPinyin: 'tā jīnnián | shí’èr suì.', translation: 'Ela tem doze anos.' },
  { id: 'a2-your-age-ji', hanzi: '你几岁了？', spokenPinyin: 'ní jǐ | suì le?', translation: 'Quantos anos você tem?' },
  { id: 'a2-your-age-duoda', hanzi: '你多大了？', spokenPinyin: 'nǐ duō dà le?', translation: 'Quantos anos você tem?' },
  { id: 'a2-age-twenty-six', hanzi: '我二十六岁了。', spokenPinyin: 'wǒ èrshíliù | suì le.', translation: 'Tenho vinte e seis anos.' },
  { id: 'a2-mother-age', hanzi: '您妈妈几岁？', spokenPinyin: 'nín māma | jǐ suì?', translation: 'Quantos anos tem a sua mãe?' },
  { id: 'a2-mother-fifty-eight', hanzi: '我妈妈今年五十八岁。', spokenPinyin: 'wǒ māma | jīnnián | wǔshíbā suì.', translation: 'Minha mãe tem cinquenta e oito anos.' },
  { id: 'a2-brother-age', hanzi: '你哥哥几岁？', spokenPinyin: 'nǐ gēge | jǐ suì?', translation: 'Quantos anos tem o seu irmão mais velho?' },
  { id: 'a2-brother-thirty-six', hanzi: '我哥哥三十六岁。', spokenPinyin: 'wǒ gēge | sānshíliù suì.', translation: 'Meu irmão mais velho tem trinta e seis anos.' },
  { id: 'a2-child-age', hanzi: '小朋友，你几岁了？', spokenPinyin: 'xiǎopéngyou, | ní jǐ | suì le?', translation: 'Criança, quantos anos você tem?' },
  { id: 'a2-six', hanzi: '我六岁了。', spokenPinyin: 'wǒ liù suì le.', translation: 'Tenho seis anos.' },
  { id: 'a2-grade-question', hanzi: '你上几年级了？', spokenPinyin: 'nǐ shàng | jǐ niánjí le?', translation: 'Em que ano escolar você está?' },
  { id: 'a2-first-grade', hanzi: '我上一年级。', spokenPinyin: 'wǒ shàng | yī niánjí.', translation: 'Estou no primeiro ano.' },
  { id: 'a2-daughter-fifteen', hanzi: '我女儿十五岁了。', spokenPinyin: 'wó nǚ’ér | shíwǔ suì le.', translation: 'Minha filha tem quinze anos.' },
];
