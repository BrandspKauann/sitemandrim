...
const GROUPS: VocabularyGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'bing', hanzi: '病', pinyin: 'bìng', meaning: 'adoecer' },
      ...
      { id: 'dushu', hanzi: '读书', pinyin: 'dúshū', meaning: 'estudar' },
      ...
      { id: 'jian', hanzi: '见', pinyin: 'jiàn', meaning: 'ver' },
      ...
      { id: 'kan', hanzi: '看', pinyin: 'kàn', meaning: 'ver' },
      ...
      { id: 'qingwen', hanzi: '请问', pinyin: 'qǐngwèn', meaning: 'perguntar' },
      ...
      { id: 'shangban', hanzi: '上班', pinyin: 'shàngbān', meaning: 'trabalhar' },
      { id: 'shangke', hanzi: '上课', pinyin: 'shàngkè', meaning: 'ter aula' },
      { id: 'shangxue', hanzi: '上学', pinyin: 'shàngxué', meaning: 'estudar' },
      { id: 'shengbing', hanzi: '生病', pinyin: 'shēngbìng', meaning: 'adoecer' },
      { id: 'shi', hanzi: '是', pinyin: 'shì', meaning: 'ser' },
      { id: 'shui-dormir', hanzi: '睡', pinyin: 'shuì', meaning: 'dormir' },
      { id: 'shuijiao', hanzi: '睡觉', pinyin: 'shuìjiào', meaning: 'dormir' },
      ...
      { id: 'wen', hanzi: '问', pinyin: 'wèn', meaning: 'perguntar' },
      ...
      { id: 'xiang', hanzi: '想', pinyin: 'xiǎng', meaning: 'querer' },
      ...
      { id: 'xuexi', hanzi: '学习', pinyin: 'xuéxí', meaning: 'estudar' },
      { id: 'yao', hanzi: '要', pinyin: 'yào', meaning: 'querer' },
